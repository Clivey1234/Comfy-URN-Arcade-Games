...
const EXTENSION_NAME = "urn.arcade.lunar_lander";
const NODE_NAME = "URNArcadeLunarLander";

function createGame(node) {
    const ui = createShell({
        aria: "URN Arcade Lunar Lander. Left and right arrows rotate. Up arrow fires the landing thruster.",
...
registerArcadeNode({extensionName:EXTENSION_NAME,nodeName:NODE_NAME,gameProp:"__urnArcadeLunarLanderGame",failProp:"__urnArcadeLunarLanderFail",patchProp:"__urnArcadeLunarLanderPatch",widgetName:"lunar_lander_game",createGame,minW:500,minH:570});
