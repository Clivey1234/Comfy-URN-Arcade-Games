...
const EXTENSION_NAME="urn.arcade.missile_command", NODE_NAME="URNArcadeMissileCommand";
function createGame(node){
    const ui=createShell({aria:"URN Arcade Missile Command. Move mouse to aim, click to fire. Arrow keys also move crosshair; Space fires.",columns:4,accent:"#ff2c2c"});
...
registerArcadeNode({extensionName:EXTENSION_NAME,nodeName:NODE_NAME,gameProp:"__urnArcadeMissileGame",failProp:"__urnArcadeMissileFail",patchProp:"__urnArcadeMissilePatch",widgetName:"missile_command_game",createGame,minW:480,minH:560});
