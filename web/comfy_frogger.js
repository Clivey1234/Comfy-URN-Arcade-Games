...
const EXTENSION_NAME="spb1234t.ComfyFrogger.V27", NODE_NAME="ComfyFroggerSPB1234T";

function createGame(node){
    const ui=createShell({aria:"Comfy Frogger. Arrow keys to hop.",columns:4,accent:"#55ff45"});
...
registerArcadeNode({extensionName:EXTENSION_NAME,nodeName:NODE_NAME,gameProp:"__comfyFroggerGame",failProp:"__comfyFroggerFail",patchProp:"__comfyFroggerPatch",widgetName:"frogger_game",createGame,minW:480,minH:560});
